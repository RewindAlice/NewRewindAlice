    ...
    public void GimmickDecision(Player alice, Player.PlayerAction action)
    {
        ...
        switch(gimmickNumArray[posY, posX, posZ])
        {
            ...
            case IVY_FRONT:
                ...
                else if (gimmickObjectArray[posY, posX, posZ].GetComponent<Ivy>().eraseFlag)
                {
            ...
            case LADDER_FRONT:
                ...
                else if (gimmickObjectArray[posY, posX, posZ].GetComponent<Ladder>().breakFlag)
                {
                    alice.SetAnimation(Player.Motion.CLIMB_START, false);
                }
                else if (!gimmickObjectArray[posY, posX, posZ].GetComponent<Ladder>().breakFlag)
            ...
            case IVY_BACK:
                ...
                else if (!gimmickObjectArray[posY, posX, posZ].GetComponent<Ivy>().climbPossibleFlag)
                {
                    alice.SetAnimation(Player.Motion.CLIMB_START, false);
                }
                else if (!gimmickObjectArray[posY, posX, posZ].GetComponent<Ivy>().eraseFlag)
                    ...
                    switch (gimmickNumArray[y, x, z])
                    {
						...
						case SOLDIER_HEART_RIGHT:
							if (y > 0)
							{
								if (gimmickNumArray[y - 1, x, z] == NONE_BLOCK)
								{
									gimmickObjectArray[y, x, z].GetComponent<HeartSoldierTurnRight>().Fall();
									GameObject objectTemp;
									objectTemp = gimmickObjectArray[y - 1, x, z];
									gimmickObjectArray[y - 1, x, z] = gimmickObjectArray[y, x, z];
									gimmickObjectArray[y, x, z] = objectTemp;

									gimmickNumArray[y - 1, x, z] = SOLDIER_HEART_RIGHT;
									gimmickNumArray[y, x, z] = NONE_BLOCK;
								}
							}
							break;
