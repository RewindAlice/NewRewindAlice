                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if ((alice.climbMidstFlag) &&
                                ...
                                ((alice.playerAngle == Player.PlayerAngle.BACK) && (alice.cameraAngle == PlayerCamera.CameraAngle.RIGHT) && (!stage.ClimbMidstBesideDecision(alice.GetComponent<Player>().arrayPosX - 1, alice.GetComponent<Player>().arrayPosY - 1, alice.GetComponent<Player>().arrayPosZ))) ||
                                ((alice.playerAngle == Player.PlayerAngle.LEFT) && (alice.cameraAngle == PlayerCamera.CameraAngle.FRONT) && (!stage.ClimbMidstBesideDecision(alice.GetComponent<Player>().arrayPosX, alice.GetComponent<Player>().arrayPosY - 1, alice.GetComponent<Player>().arrayPosZ - 1))) ||
                                ((alice.playerAngle == Player.PlayerAngle.LEFT) && (alice.cameraAngle == PlayerCamera.CameraAngle.BACK) && (!stage.ClimbMidstBesideDecision(alice.GetComponent<Player>().arrayPosX, alice.GetComponent<Player>().arrayPosY - 1, alice.GetComponent<Player>().arrayPosZ + 1))) ||
                                ((alice.playerAngle == Player.PlayerAngle.RIGHT) && (alice.cameraAngle == PlayerCamera.CameraAngle.FRONT) && (!stage.ClimbMidstBesideDecision(alice.GetComponent<Player>().arrayPosX, alice.GetComponent<Player>().arrayPosY - 1, alice.GetComponent<Player>().arrayPosZ - 1))) ||
                                ((alice.playerAngle == Player.PlayerAngle.RIGHT) && (alice.cameraAngle == PlayerCamera.CameraAngle.BACK) && (!stage.ClimbMidstBesideDecision(alice.GetComponent<Player>().arrayPosX, alice.GetComponent<Player>().arrayPosY - 1, alice.GetComponent<Player>().arrayPosZ + 1))))
                            {
                                // 座標のリセット
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if ((alice.climbMidstFlag) &&
                                ...
                                ((alice.playerAngle == Player.PlayerAngle.BACK) && (alice.cameraAngle == PlayerCamera.CameraAngle.BACK) && (!stage.ClimbMidstBesideDecision(alice.GetComponent<Player>().arrayPosX - 1, alice.GetComponent<Player>().arrayPosY - 1, alice.GetComponent<Player>().arrayPosZ))) ||
                                ((alice.playerAngle == Player.PlayerAngle.LEFT) && (alice.cameraAngle == PlayerCamera.CameraAngle.LEFT) && (!stage.ClimbMidstBesideDecision(alice.GetComponent<Player>().arrayPosX, alice.GetComponent<Player>().arrayPosY - 1, alice.GetComponent<Player>().arrayPosZ + 1))) ||
                                ((alice.playerAngle == Player.PlayerAngle.LEFT) && (alice.cameraAngle == PlayerCamera.CameraAngle.RIGHT) && (!stage.ClimbMidstBesideDecision(alice.GetComponent<Player>().arrayPosX, alice.GetComponent<Player>().arrayPosY - 1, alice.GetComponent<Player>().arrayPosZ - 1))) ||
                                ((alice.playerAngle == Player.PlayerAngle.RIGHT) && (alice.cameraAngle == PlayerCamera.CameraAngle.LEFT) && (!stage.ClimbMidstBesideDecision(alice.GetComponent<Player>().arrayPosX, alice.GetComponent<Player>().arrayPosY - 1, alice.GetComponent<Player>().arrayPosZ + 1))) ||
                                ((alice.playerAngle == Player.PlayerAngle.RIGHT) && (alice.cameraAngle == PlayerCamera.CameraAngle.RIGHT) && (!stage.ClimbMidstBesideDecision(alice.GetComponent<Player>().arrayPosX, alice.GetComponent<Player>().arrayPosY - 1, alice.GetComponent<Player>().arrayPosZ - 1))))
                            {
                                // 座標のリセット
                                alice.transform.position = new Vector3(alice.GetComponent<Player>().arrayPosX, alice.GetComponent<Player>().arrayPosY - 0.5f, alice.GetComponent<Player>().arrayPosZ);
                            }
