...
public class BaseGimmick : MonoBehaviour
{
    ...
    // ★移動可能フラグを設定★〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓
    public virtual void SetMovePossibleFlag(bool possibleFlag)
    {
        movePossibleFlag = possibleFlag;    // 移動可能フラグを設定
    }

    // ★移動可能フラグを取得★〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓
    public virtual bool GetMovePossibleFlag()
    {
        return movePossibleFlag;    // 移動可能フラグを返す
    }
}